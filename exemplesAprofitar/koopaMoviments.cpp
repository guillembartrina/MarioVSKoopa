...
int main() {
  ...
  const char TEXTURE_FILE[] = "res/img/koopaTroopa.png";
  int etapa = 0;
  ...
  for (int i = 0; i < 329; i++) {
    int posX1 = i * ampImatge % (23 * ampImatge);
	int posY1 = altImatge * int(i / 23);
	animation.addFrame({posX1, 6 + posY1, ampImatge, altImatge});
  }
  animation.play();
  ...
  for (int i = 437; i < 759; i++) {
    int posX1 = i * ampImatge % (23 * ampImatge);
	int posY1 = altImatge * int(i / 23);
	standR.addFrame({posX1, 6 + posY1, ampImatge, altImatge});
  }
  standR.play();
  ...
  for (int i = 345; i < 355; i++) {
    int posX1 = i * ampImatge % (23 * ampImatge);
	int posY1 = altImatge * int(i / 23);
	walkingR.addFrame({posX1, 6 + posY1, 40, altImatge});
  }
  walkingR.play();
  ...
  for (int i = 392; i < 401; i++) {
    int posX1 = i * ampImatge % (23 * ampImatge);
	int posY1 = altImatge * int(i / 23);
	walkingL.addFrame({posX1, 6 + posY1, 40, altImatge});
  }
  walkingL.play();
